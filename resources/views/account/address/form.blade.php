...
<head>
    <title>Bantenese Furniture : Form Alamat</title>
</head>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input name="no_wa" type="number" class="form-control" placeholder="Nomor WhatsApp" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">Kode Pos</label>
                                            <input name="post_code" type="number" class="form-control" placeholder="Kode Pos" required>
                                        </div>
                                    </div>
