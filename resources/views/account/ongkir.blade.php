                ...
                <div class="col-md-9">
                    <div class="transparen card shopping-cart">
                        <div class="card-body">
                            ...
                            <form action="/updateongkir" method="post">
                                @csrf
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="ongkir" required>
                                                ...
                                                <option value="{{ $l['cost'][0]['value'] }}">{{ $l['service'] }} - {{ $l['cost'][0]['value'] }} - ({{ $l['cost'][0]['etd'] }} Hari)</option>

                                                @empty
                                                <option>Layanan Kosong, Silakan Pilih Kurir Lain</option>
                                                @endforelse
                                ...
                                <button type="submit" class="btn btn-outline-dark float-right">Checkout</button>
                            </form>
                        </div>
                    </div>
                </div>
