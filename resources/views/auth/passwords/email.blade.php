        ...
        <div class="container mt-n5" style="margin-top: -30vh !important;">
            ...
            <div>
                <div class="container justify-content-center mb-5">
                    ...
                    <h5 class="p text-center">Silakan Masukkan Email Anda</h5>
                </div>
                ...
                <div class="d-flex justify-content-center">
                    <form method="post" action="{{ route('password.email') }}" class="col-md-6">
                        @csrf
                        ...
                        <div class="d-flex justify-content-center mt-5">
                            <button type="submit" class="btn rounded-pill btn-lg">Kirim Link Reset Password</button>
                        </div>
                    </form>
