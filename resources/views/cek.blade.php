...
-->
               ...
               <input type="hidden" name="city_origin" value="{{ $pesanan->id }}">
               <input type="hidden" name="city_destination" value="{{ $pesanan->address_id }}">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ $pesanan->total_weight }}" class="form-control" name="weight" id="weight" placeholder="Masukkan Berat (GRAM)">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="card d-none ongkir">
                    <div class="card-body">
                        <select class="form-control kurir" id="ongkir" name="courier">
